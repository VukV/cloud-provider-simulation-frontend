...
export class ScheduleComponent implements OnInit {
  ...
  getAllowedActions(){
    if(this.userService.checkUserRole(RoleEnum.START_MACHINES)){
      this.allowedActions.push(MachineActionEnum.START);
    }
    if(this.userService.checkUserRole(RoleEnum.STOP_MACHINES)){
      this.allowedActions.push(MachineActionEnum.STOP);
    }
    if(this.userService.checkUserRole(RoleEnum.RESTART_MACHINES)){
